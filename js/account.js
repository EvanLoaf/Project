...
$(document).ready(function () {
    ...
    var form = $("<form>").attr({ 'action': '#', 'name': 'signinForm', 'class': 'form', 'id': 'regForm' })
    ...
    var secondLabel = $("<label>").attr('for', 'password').html("Пароль");
    var secondInput = $("<input>").attr({ 'type': 'password', 'id': 'password', 'name': 'password', 'placeholder': 'например, ••••••••••••' });
