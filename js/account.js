$(document).ready(function () {
    ...
    var secondInput = $("<input>").attr({'type':'password','id':'passwor','name':'password','placeholder':'например, 123456'});
    
    var button = $("<input>").attr({'type':'submit','onClick':'signIn()','value':'Войти','class':'registration button'});
    var br = $("<br>");
